...
urlpatterns =[
    ...
    path('immigration/express_entry', mainapp_en.Express_entry_en.as_view(), name='immigration-express_entry_en'),
    path('immigration/business_class', mainapp_en.Business_class_en.as_view(), name='immigration-business_class_en'),
    path('immigration/family_sponsorship', mainapp_en.Family_sponsorship_en.as_view(), name='immigration-family_sponsorship_en'),
    path('immigration/CAIPS', mainapp_en.Caips_en.as_view(), name='immigration-caips_en'),
    path('immigration/custodianship', mainapp_en.Custodianship_en.as_view(), name='immigration-custodianship_en'),
